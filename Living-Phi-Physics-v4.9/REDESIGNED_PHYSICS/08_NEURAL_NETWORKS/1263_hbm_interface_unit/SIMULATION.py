...
class HbmInterfaceProcessingUnitSimulation:
    """Full simulation environment for HBM Interface Processing Unit
    ...
    def __init__(self):
        self.results = {
            "device_name": "HBM Interface Processing Unit",
            "item_id": 1263,
    ...
    def run_full_simulation(self) -> Dict:
        print(f"Simulating: HBM Interface Processing Unit")
        print("=" * 60)
    ...
    def export_results(self, filepath: str = None) -> str:
        if filepath is None:
            filepath = f"simulation_results_1263.json"
...
if __name__ == "__main__":
    sim = HbmInterfaceProcessingUnitSimulation()
