...
class TensorSplitMergeUnitSimulation:
    """Full simulation environment for Tensor Split/Merge Unit
    ...
    def __init__(self):
        self.results = {
            "device_name": "Tensor Split/Merge Unit",
            "item_id": 1277,
    ...
    def run_full_simulation(self) -> Dict:
        print(f"Simulating: Tensor Split/Merge Unit")
        print("=" * 60)
    ...
    def export_results(self, filepath: str = None) -> str:
        if filepath is None:
            filepath = f"simulation_results_1277.json"
...
if __name__ == "__main__":
    sim = TensorSplitMergeUnitSimulation()
