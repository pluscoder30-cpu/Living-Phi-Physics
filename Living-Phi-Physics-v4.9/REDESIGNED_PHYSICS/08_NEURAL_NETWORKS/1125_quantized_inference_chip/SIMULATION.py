...
class Int8Int4QuantizedInferenceChipSimulation:
    """Full simulation environment for INT8/INT4 Quantized Inference Chip
    ...
    def __init__(self):
        self.results = {
            "device_name": "INT8/INT4 Quantized Inference Chip",
            "item_id": 1125,
    ...
    def run_full_simulation(self) -> Dict:
        print(f"Simulating: INT8/INT4 Quantized Inference Chip")
        print("=" * 60)
    ...
    def export_results(self, filepath: str = None) -> str:
        if filepath is None:
            filepath = f"simulation_results_1125.json"
...
if __name__ == "__main__":
    sim = Int8Int4QuantizedInferenceChipSimulation()
