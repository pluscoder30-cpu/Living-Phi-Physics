...
class UpsamplingProcessingUnitSimulation:
    """Full simulation environment for Upsampling Processing Unit
    ...
    def __init__(self):
        self.results = {
            "device_name": "Upsampling Processing Unit",
            "item_id": 1271,
    ...
    def run_full_simulation(self) -> Dict:
        print(f"Simulating: Upsampling Processing Unit")
        print("=" * 60)
    ...
    def export_results(self, filepath: str = None) -> str:
        if filepath is None:
            filepath = f"simulation_results_1271.json"
...
if __name__ == "__main__":
    sim = UpsamplingProcessingUnitSimulation()
