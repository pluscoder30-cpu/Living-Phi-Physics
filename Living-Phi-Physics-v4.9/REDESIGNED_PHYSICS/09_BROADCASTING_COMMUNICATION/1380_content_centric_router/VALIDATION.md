# Validation: 1380: Content Centric Router
...
All tests pass. The device correctly implements phi-harmonic principles for named-data forwarding engine routing by content name rather than ip address. applications.
