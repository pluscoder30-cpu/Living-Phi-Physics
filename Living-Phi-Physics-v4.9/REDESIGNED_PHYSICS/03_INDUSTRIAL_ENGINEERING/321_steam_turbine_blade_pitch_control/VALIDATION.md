# ITEM 321: STEAM TURBINE BLADE PITCH CONTROL — Validation
...
|---------------------|----------------|---------------|
| 6-8% efficiency gain at partial load via phi-coordinated blade phasing | Quantitative | Simulation parameter sweep |
