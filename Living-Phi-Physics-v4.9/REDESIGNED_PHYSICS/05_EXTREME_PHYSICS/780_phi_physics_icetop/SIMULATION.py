#!/usr/bin/env python3
"""Simulation for ITEM 780: PHI-PHYSICS ICETOP"""
...
def simulate_item_780():
    """Run simulation for ITEM 780: PHI-PHYSICS ICETOP"""
    results = {}
    
    # Base parameters
    results['phi'] = PHI
    results['c_crit'] = C_CRIT
    results['item_number'] = 780
    results['item_name'] = "PHI-PHYSICS ICETOP"
...
if __name__ == "__main__":
    print(f"Simulation: ITEM 780: PHI-PHYSICS ICETOP")
    print(f"Author: Christopher David Ayotte")
    print("=" * 60)
    
    results = simulate_item_780()
