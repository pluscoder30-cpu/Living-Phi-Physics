#!/usr/bin/env python3
"""Simulation for ITEM 651: PHI-PHYSICS NUCLEAR THERMAL ROCKET"""
...
def simulate_item_651():
    """Run simulation for ITEM 651: PHI-PHYSICS NUCLEAR THERMAL ROCKET"""
    results = {}
    
    # Base parameters
    results['phi'] = PHI
    results['c_crit'] = C_CRIT
    results['item_number'] = 651
    results['item_name'] = "PHI-PHYSICS NUCLEAR THERMAL ROCKET"
...
if __name__ == "__main__":
    print(f"Simulation: ITEM 651: PHI-PHYSICS NUCLEAR THERMAL ROCKET")
    print(f"Author: Christopher David Ayotte")
    print("=" * 60)
    
    results = simulate_item_651()
